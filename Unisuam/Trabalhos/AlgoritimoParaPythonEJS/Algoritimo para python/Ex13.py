#Calcule a média aritmética das 3 notas de um aluno e mostre, além do valor da média, uma mensagem de "Aprovado", caso a média seja igual ou superior a 7,  a mensagem “em prova final” caso a média seja menor que 7 e maior ou igual a 4 e "reprovado", caso contrário.
